...
and modified to reflect the proprietary, contribution-restricted nature of the FUL project
maintained by **AI Craftsman Brotherhood**.

FUL is a proprietary / source-available project. Code contributions are limited to
authorized personnel only (see [CONTRIBUTING.md](CONTRIBUTING.md)). This Code of Conduct
applies to all interactions within the project, including Issue discussions, security
reports, and any other community spaces.

## Our Pledge

We as maintainers, authorized contributors, and users pledge to make participation in
our project a harassment-free experience for everyone, regardless of age, body size,
...
We pledge to act and interact in ways that contribute to a welcoming, respectful, and
...
comments, issues, and other contributions that are not aligned to this Code of Conduct,
...
Examples include using an official e-mail address, posting via an official social media
...
**support@craftsman-bro.com**. All complaints will be reviewed and investigated
promptly and fairly.
