...
class MetricsCalculatorTest {
  ...
  void calculateMaxNestingDepthJdt_withMockedTree_returnsTwo() {
    ...
    doAnswer(
            invocation -> {
              org.eclipse.jdt.core.dom.ASTVisitor visitor = invocation.getArgument(0);
              visitor.preVisit(rootBlock);
              visitor.preVisit(ifStatement);
              visitor.preVisit(whileStatement);
              visitor.preVisit(leafStatement);
              visitor.postVisit(leafStatement);
              visitor.postVisit(whileStatement);
              visitor.preVisit(forStatement);
              visitor.postVisit(forStatement);
              visitor.postVisit(ifStatement);
              visitor.preVisit(enhancedForStatement);
              visitor.postVisit(enhancedForStatement);
              visitor.preVisit(doStatement);
              visitor.postVisit(doStatement);
              visitor.preVisit(switchStatement);
              visitor.postVisit(switchStatement);
              visitor.preVisit(conditionalExpression);
              visitor.preVisit(thenExpression);
              visitor.postVisit(thenExpression);
              visitor.preVisit(elseExpression);
              visitor.postVisit(elseExpression);
              visitor.postVisit(conditionalExpression);
              visitor.preVisit(catchClause);
              visitor.postVisit(catchClause);
              visitor.preVisit(leafStatement);
              visitor.postVisit(leafStatement);
              visitor.postVisit(rootBlock);
              return null;
            })
        .when(rootBlock)
        .accept(any(org.eclipse.jdt.core.dom.ASTVisitor.class));
