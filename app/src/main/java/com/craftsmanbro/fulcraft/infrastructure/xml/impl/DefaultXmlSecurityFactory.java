...
public final class DefaultXmlSecurityFactory implements XmlSecurityFactoryPort {
  ...
  private void configureDocumentBuilderFeatures(final DocumentBuilderFactory factory) {
    try {
      ...
      factory.setFeature(DISALLOW_DOCTYPE_DECL_FEATURE, profile.disallowDoctypeDeclaration());
      factory.setFeature(EXTERNAL_GENERAL_ENTITIES_FEATURE, profile.allowExternalGeneralEntities());
      factory.setFeature(
