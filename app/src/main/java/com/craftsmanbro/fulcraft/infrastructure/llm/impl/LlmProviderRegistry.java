...
public final class LlmProviderRegistry {
  ...
  public static void registerProvider(final LlmClientProvider provider) {
    Objects.requireNonNull(
        provider,
        MessageSource.getMessage("infra.common.error.argument_null", "provider must not be null"));
  ...
  private static void discoverProviders() {
    try {
      ...
      Logger.warn("Failed to discover LLM PROVIDERS via ServiceLoader: " + e.getMessage());
    }
  }
