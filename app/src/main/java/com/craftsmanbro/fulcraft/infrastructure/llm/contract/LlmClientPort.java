...
public interface LlmClientPort {
  ...
  default String generateTest(final String prompt, final String model) {
    Objects.requireNonNull(
        prompt,
        MessageSource.getMessage("infra.common.error.argument_null", "Prompt must not be null"));
    Objects.requireNonNull(
        model,
        MessageSource.getMessage("infra.common.error.argument_null", "Model must not be null"));
