 ...
 *
 * <p>This contract hides the underlying JSON library (e.g., Jackson) from most consumers, providing
 * a stable API that does not leak third-party types. Common application-level JSON operations
