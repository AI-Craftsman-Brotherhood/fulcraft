...
final class CacheEncryptor {
   ...
   * @return the encrypted text (Base64-encoded), or the original text if encryption is disabled
   */
  public String encrypt(final String plainText) {
    ...
    try {
      ...
      final byte[] combinedCipherBytes =
          new byte[initializationVector.length + encryptedBytes.length];
      System.arraycopy(
