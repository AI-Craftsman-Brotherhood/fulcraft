...
public class DynamicSelectionRules {
  ...
  private final com.craftsmanbro.fulcraft.plugins.analysis.config.SelectionRulesConfig
      config;

  public DynamicSelectionRules(
      final com.craftsmanbro.fulcraft.plugins.analysis.config.SelectionRulesConfig
          config) {
    this.config =
        config != null
            ? config
