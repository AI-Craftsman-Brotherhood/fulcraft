...
public class CommonMethodAnalyzer {
    ...
    method
        ...
        .forEach(
            ne -> {
              ...
              if (!LOCAL_RESULT.equals(name)
                  && !LOCAL_PRIME.equals(name)
                  && !LOCAL_HASH.equals(name)) {
                fields.add(name);
              }
            });
    return new ArrayList<>(fields);
  ...
  public String formatHintsForPrompt(final MethodHints hints, final String methodName) {
    ...
    if (METHOD_TO_STRING.equals(methodName) && hints.toStringFormat() != null) {
      promptBuilder
          .append("Expected toString() format pattern: ")
          .append(hints.toStringFormat())
          .append("\n");
    ...
    if (METHOD_EQUALS.equals(methodName)
      ...
      promptBuilder
          .append("Fields compared in equals(): ")
          .append(String.join(", ", hints.equalsFields()))
          .append("\n");
      promptBuilder.append(
          "IMPORTANT: Test cases should verify equality based on these specific fields.\n");
    ...
    if (METHOD_HASH_CODE.equals(methodName)
      ...
      promptBuilder
          .append("Fields used in hashCode(): ")
          .append(String.join(", ", hints.hashCodeFields()))
          .append("\n");
      promptBuilder.append(
          "IMPORTANT: Objects with same values for these fields should have same hashCode.\n");
      promptBuilder.append(
          "- Verify hashCode consistency: x.hashCode() == x.hashCode() for same object.\n");
      promptBuilder.append(
          "- Verify contract: if x.equals(y), then x.hashCode() == y.hashCode().\n");
    }
